  ...
  <el-container style="height: 500px; border: 1px solid #eee">
    ...
    <el-main>
      <el-table :data="tableData" border style="width: 100%" ref="multipleTable" tooltip-effect="dark" @selection-change="handleSelectionChange" >
        ...
        <el-table-column prop="date" label="发帖日期" width="120">
        </el-table-column>
        <el-table-column prop="content" label="博文内容" width="120">
        </el-table-column>
        ...
        <el-table-column prop="check" label="详细信息" width="220">
          <template #default="scope">
            <el-button size="mini" type="primary" @click="handleCheck(check.$index, scope.row)">查看</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-main>
